...
public class Main {
	...
	public static void main(String[] args) {
		...
		Subscription s1 = new Subscription("abbonamento 1", "Lombardia", 1300.2, reseller1);
		Subscription s2 = new Subscription("abbonamento 2", "Lazio", 300.2, reseller2);
		pd1.save(s1);
		pd1.save(s2);
		
		List<Pass> PassTot = s1.listaTotPass(1,LocalDate.of(2023, 5, 23), LocalDate.of(2023, 5, 25));
