...
public class PassDAO implements IPassDAO {
	...
	public void save(Pass p) {
		...
		try {
			...
			System.out.println(String.format("Error saving pass: %s", e.getMessage()));
			em.getTransaction().rollback();
	...
	public Pass getById(long id) {
		...
		try {
			...
			em.getTransaction().rollback();
			System.out.println(String.format("Error getting pass by id: %s", id));
			System.out.println(e.getMessage());
		} finally {
			em.close();
		}
	...
	public List<Pass> getAll() {
		...
		try {
			...
			em.getTransaction().rollback();
			System.out.println(String.format("Error getting all passes: %s", e.getMessage()));
			System.out.println(e.getMessage());
		} finally {
			em.close();
		}
	...
	public void update(Pass pass) {
		...
		try {
			...
			em.getTransaction().rollback();
			System.out.println(String.format("Error updating pass: %s", e.getMessage()));
			em.getTransaction().rollback();
			System.out.println(e.getMessage());
		} finally {
			em.close();
	...
	public void delete(long id) {
		...
		try {
			...
			em.getTransaction().rollback();
			System.out.println(String.format("Error removing pass by id: %s", id));
			em.getTransaction().rollback();
			System.out.println(e.getMessage());
		} finally {
			em.close();
	...
	public List<Pass> listaTotPass(long id, LocalDate inizio, LocalDate fine) {
		...
		try {
			...
			em.getTransaction().rollback();
			System.out.println(String.format("Errore durante la ricerca di tutte le carte: %s", e.getMessage()));
			System.out.println(e.getMessage());
			return null;
		} finally {
			em.close();
	...
	public List<Pass> getEndorsedTicketsInTimeRange(LocalDate startTime, LocalDate endTime) {
		...
		try {
			...
			System.out.println("Errore: impossibile recuperare i ticket vidimati in questo periodo");
			System.out.println(e.getMessage());
		} finally {
			entityManager.close();
